class Question {
  ...
  display(){
    ...
    this.question.html("O que é que está no meio do começo, no começo do meio, e no final do fim? " );
    // question.html("Pergunta:- O que é que está no meio do começo, no começo do meio, e no final do fim? " );

    this.question.position(150, 80);
    this.option1.html("A) A letra E " );
    this.option1.position(150, 100);
    this.option2.html("B) A letra M" );
    this.option2.position(150, 120);
    this.option3.html("C) A letra I" );
    this.option3.position(150, 140);
    this.option4.html("D) A letra O" );
